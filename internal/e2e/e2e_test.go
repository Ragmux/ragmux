...
func TestMetricsExportAndSummaryOptions(t *testing.T) {
	...
	if len(lines) != 4 || lines[0] != "created_at,project_id,project_name,model_name,status_code,prompt_tokens,completion_tokens,estimated,latency_ms,streamed,rag_used,rag_hits,error,cached_prompt_tokens,cache_write_tokens,cost_usd,cost_source" {
